        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div className="lg:col-span-4 space-y-6 relative">
                    ...
                    {/* Task Navigation Section - Sticky */}
                    {tasks.length > 0 && (
                        <div
                            ref={quickNavRef}
                            className="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 border border-gray-100 dark:border-gray-700 sticky top-6"
                        >
                            <div className="flex items-center mb-4">
